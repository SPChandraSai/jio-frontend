...
function ResetPassword() {
  ...
  return (
    ...
    <>
          ...
          <CardContent className="grid gap-2">
            <div className="grid gap-2">
              ...
              <Input
                ...
                required
              />
              <Button className="mt-6 bg-pink-600" onClick={handleForgetPassword}>
                Send OTP
                {loading && (
      ...
      {/* reset Password dialog box -> by default hidden */}
        ...
        <DialogOverlay>
          <DialogContent className="p-4 bg-black rounded-lg shadow-lg">
            ...
            <div className="flex justify-end mt-4">
              <Button type="submit" className="bg-pink-600" onClick={handleResetPassword}>
                Submit
                {loading && (
                  <LucideLoader2 className="animate-spin ml-2 w-4 h-4" />
                )}
